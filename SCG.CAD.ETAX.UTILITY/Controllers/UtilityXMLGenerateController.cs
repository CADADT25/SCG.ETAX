...
{
    public class UtilityXMLGenerateController
    {
        ...
        UtilityProfileReasonIssueController profileReasonIssueController = new UtilityProfileReasonIssueController();
        ...
        public Response GetConfigXMLGenerator()
        {
            ...
            {
                res.STATUS = true;
                res.OUTPUT_DATA = configXMLGeneratorController.List().Result;
            }
            catch (Exception ex)
            {
                res.STATUS = false;
        ...
        public Response GetTaxCode()
        {
            ...
            {
                res.STATUS = true;
                res.OUTPUT_DATA = taxCodeController.List().Result;
            }
            catch (Exception ex)
            {
                res.STATUS = false;
        ...
        public Response GetDocumentCode()
        {
            ...
            {
                res.STATUS = true;
                res.OUTPUT_DATA = documentCodeController.List().Result;
            }
            catch (Exception ex)
            {
                res.STATUS = false;
        ...
        public Response GetProfileCompany()
        {
            ...
            {
                res.STATUS = true;
                res.OUTPUT_DATA = profileController.ProfileCompanyList().Result;
            }
            catch (Exception ex)
            {
                res.STATUS = false;
        ...
        public Response GetProfileSeller()
        {
            ...
            {
                res.STATUS = true;
                res.OUTPUT_DATA = profileController.ProfileSellerList().Result;
            }
            catch (Exception ex)
            {
                res.STATUS = false;
        ...
        public Response GetProductUnit()
        {
            ...
            {
                res.STATUS = true;
                res.OUTPUT_DATA = productUnitController.List().Result;
            }
            catch (Exception ex)
            {
                res.STATUS = false;
        ...
        public Response GetProfileBranch()
        {
            ...
            {
                res.STATUS = true;
                res.OUTPUT_DATA = profileBranchController.List().Result;
            }
            catch (Exception ex)
            {
                res.STATUS = false;
        ...
        public Response GetProfileReasonIssue()
        {
            ...
            {
                res.STATUS = true;
                res.OUTPUT_DATA = profileReasonIssueController.List().Result;
            }
            catch (Exception ex)
            {
                res.STATUS = false;
        ...
        public Response InsertDataTransactionDescription(TextFileSchematic dataxml, string source, List<DocumentCode> documentCode, List<ProfileCompany> profileCompany)
        {
            ...
            try
            {
                ...
                if (resp.Result.MESSAGE == "Updated Success." || resp.Result.MESSAGE == "Insert success.")
                {
                    res.STATUS = true;
                }
            }
