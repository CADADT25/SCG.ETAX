    ...
    public class ResetXMLZip
    {
        ...
        public bool ResetStatusXMLZipByRecord(string billno, string updateby)
        {
            ...
            try
            {
                ...
                {
                    if (transactionDescription.XmlCompressStatus != "Waiting")
                    {
                        transactionDescription.XmlCompressStatus = "Waiting";
                        transactionDescription.XmlCompressDetail = "Reset Status";
                        transactionDescription.XmlCompressDateTime = DateTime.Now;
