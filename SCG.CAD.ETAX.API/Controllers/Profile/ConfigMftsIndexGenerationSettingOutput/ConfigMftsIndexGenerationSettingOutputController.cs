...
namespace SCG.CAD.ETAX.API.Controllers
{
    ...
    //[ApiController]
    public class ConfigMftsIndexGenerationSettingOutputController : BaseController
    {
        ...
        [HttpPost]
        [Route("UpdateOneTime")]
        public IActionResult UpdateOneTime(ConfigMftsIndexGenerationSettingOutput param)
        {
        ...
        [HttpPost]
        [Route("UpdateAnyTime")]
        public IActionResult UpdateAnyTime(ConfigMftsIndexGenerationSettingOutput param)
        {
