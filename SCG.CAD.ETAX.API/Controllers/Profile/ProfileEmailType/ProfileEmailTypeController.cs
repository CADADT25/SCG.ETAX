...
namespace SCG.CAD.ETAX.API.Controllers
{
    ...
    //[ApiController]
    public class ProfileEmailTypeController : BaseController
    {
        ...
        [HttpPost]
        [Route("Insert")]
        public IActionResult Insert(ProfileEmailType param)
        {
        ...
        [HttpPost]
        [Route("Update")]
        public IActionResult Update(ProfileEmailType param)
        {
        ...
        [HttpPost]
        [Route("Delete")]
        public IActionResult Delete(ProfileEmailType param)
        {
