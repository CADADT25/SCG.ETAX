...
namespace SCG.CAD.ETAX.API.Controllers
{
    ...
    public class ZipFileConfigController : ControllerBase
    {
        ...
        {
            repo = new ZipFileConfigRepository();
        }
        ...
        [HttpPost]
        [Route("Insert")]
        public IActionResult Insert(ZipFileConfig param)
        {
        ...
        [HttpPost]
        [Route("Update")]
        public IActionResult Update(ZipFileConfig param)
        {
        ...
        [HttpPost]
        [Route("Delete")]
        public IActionResult Delete(ZipFileConfig param)
        {
