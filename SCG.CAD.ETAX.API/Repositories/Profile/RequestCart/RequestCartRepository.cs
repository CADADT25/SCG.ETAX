namespace SCG.CAD.ETAX.API.Repositories
{
    public class RequestCartRepository : IRequestCartRepository
    {
        ...
        public async Task<Response> SEARCH_FULL_DATA(RequestCartSearchModel req)
        {
            Response resp = new Response();
            try
            {
                var result = service.SEARCH_FULL_DATA(req);
        ...
        public async Task<Response> INSERT(RequestCart param)
        {
            Response resp = new Response();
        ...
        public async Task<Response> INSERT(List<RequestCart> param)
        {
            Response resp = new Response();
        ...
        public async Task<Response> UPDATE(RequestCart param)
        {
            Response resp = new Response();
        ...
        public async Task<Response> DELETE(RequestCart param)
        {
            Response resp = new Response();
        ...
        public async Task<Response> DELETE(List<RequestCart> param)
        {
            Response resp = new Response();
