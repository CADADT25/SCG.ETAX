namespace SCG.CAD.ETAX.API.Repositories
{
    public class ZipFileTypeRepository : IZipFileTypeRepository
    {
        ...
        public async Task<Response> INSERT(ZipFileType param)
        {
            Response resp = new Response();
        ...
        public async Task<Response> UPDATE(ZipFileType param)
        {
            Response resp = new Response();
        ...
        public async Task<Response> DELETE(ZipFileType param)
        {
            Response resp = new Response();
