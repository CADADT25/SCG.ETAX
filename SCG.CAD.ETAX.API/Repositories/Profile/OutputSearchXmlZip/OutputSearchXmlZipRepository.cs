...
{
    public class OutputSearchXmlZipRepository : IOutputSearchXmlZipRepository
    {

        OutputSearchXmlZipService service = new OutputSearchXmlZipService();
        ...
        public async Task<Response> INSERT(OutputSearchXmlZip param)
        {
            Response resp = new Response();
        ...
        public async Task<Response> UPDATE(OutputSearchXmlZip param)
        {
            Response resp = new Response();
        ...
        public async Task<Response> DELETE(OutputSearchXmlZip param)
        {
            Response resp = new Response();
        ...
        public async Task<Response> DOWNLOADZIPFILE(OutputSearchXmlZip param)
        {
            Response resp = new Response();
