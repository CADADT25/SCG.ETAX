...
{
    public class ConfigMftsCompressXmlSettingRepository : IConfigMftsCompressXmlSettingRepository
    {
        ConfigMftsCompressXmlSettingService service = new ConfigMftsCompressXmlSettingService();
        ...
        public async Task<Response> INSERT(ConfigMftsCompressXmlSetting param)
        {
            Response resp = new Response();
        ...
        public async Task<Response> UPDATE(ConfigMftsCompressXmlSetting param)
        {
            Response resp = new Response();
        ...
        public async Task<Response> DELETE(ConfigMftsCompressXmlSetting param)
        {
            Response resp = new Response();
        ...
        public async Task<Response> UPDATE_ONETIME(ConfigMftsCompressXmlSetting param)
        {
            Response resp = new Response();
        ...
        public async Task<Response> UPDATE_ANYTIME(ConfigMftsCompressXmlSetting param)
        {
            Response resp = new Response();
